...
class Settings:
    ...
    RESULTS_PATH: Path = PROJECT_ROOT / os.getenv("RESULTS_PATH", "outputs/experiments/judgment_results.csv")
    
    # 日志配置
    LOG_LEVEL: str = os.getenv("LOG_LEVEL", "INFO")
    LOG_FILE: Optional[Path] = PROJECT_ROOT / os.getenv("LOG_FILE", "outputs/logs/alignment_tax.log") if os.getenv("LOG_FILE") else None
