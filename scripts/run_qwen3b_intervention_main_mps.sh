...
./.venv/bin/python scripts/build_local_probe_intervention_subset.py \
  ...
  --output-file outputs/experiments/local_probe_qwen3b_intervention_main_inputs/qwen3b_intervention_main_sample_set.json \
  --strict-positive-limit 50 \
  --high-pressure-limit 50 \
  --control-limit 8

echo "Starting 3B main intervention runs on 108 samples"
...
./.venv/bin/python scripts/run_local_probe_intervention.py \
  ...
  --output-dir outputs/experiments/local_probe_qwen3b_intervention_main/baseline_31_35_s06 \
  --device mps \
  --dtype float16 \
  ...
  --layer-configs '31-35=31,32,33,34,35' \
...
./.venv/bin/python scripts/run_local_probe_intervention.py \
  ...
  --sample-file outputs/experiments/local_probe_qwen3b_intervention_main_inputs/qwen3b_intervention_main_sample_set.json \
  --reference-mechanistic-run-dir outputs/experiments/local_probe_qwen3b_mechanistic/Qwen_Qwen2.5-3B-Instruct/20260419_131943 \
  --output-dir outputs/experiments/local_probe_qwen3b_intervention_main/subtraction_control_31_35_s06 \
  --device mps \
  --dtype float16 \
