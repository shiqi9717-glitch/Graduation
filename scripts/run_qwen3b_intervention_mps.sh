...
./.venv/bin/python scripts/run_local_probe_intervention.py \
  ...
  --reference-mechanistic-run-dir outputs/experiments/local_probe_qwen3b_mechanistic/Qwen_Qwen2.5-3B-Instruct/20260419_010547 \
  --output-dir outputs/experiments/local_probe_qwen3b_intervention \
  --device mps \
  --dtype float16 \
  ...
  --explicit-layers 31,32,33,34,35 \
