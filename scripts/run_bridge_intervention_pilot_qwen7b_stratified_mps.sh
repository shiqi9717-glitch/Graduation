...
echo "Starting Table 4 exploratory stratified bridge intervention pilot: Qwen2.5-7B, n=72, baseline_state_interpolation, layers=24-26, scale=0.6"
...
./.venv/bin/python scripts/run_bridge_intervention_pilot_qwen7b.py \
  ...
  --output-root outputs/experiments/bridge_benchmark_qwen7b_intervention_pilot_stratified \
