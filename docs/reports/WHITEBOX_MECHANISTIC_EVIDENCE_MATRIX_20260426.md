...
| Qwen2.5-3B clean protocol | Positive confirmation | clean protocol delta vs `no_intervention`: drift `-0.3750` CI `[-0.5208, -0.2292]`, compliance `-0.4167` CI `[-0.5625, -0.2708]`, recovery `+0.0833` CI `[0.0000, 0.1875]`, damage `+0.0417` CI `[0.0000, 0.1042]` | negative control 未复现收益，且 damage `+0.1458`; 可作为副主线支持，但不代表所有 Qwen clean protocol 都正向确认 | Appendix / boundary note | `paper_evidence_package_20260427/appendix_materials/qwen_clean_protocol_appendix_note.md`; `outputs/experiments/pressure_subspace_damping_qwen3b_clean/Qwen_Qwen2.5-3B-Instruct/20260430_162151/belief_causal_summary.csv` |
| Qwen2.5-7B clean protocol | Weak / mixed boundary evidence | clean protocol delta vs `no_intervention`: drift `-0.0417` CI `[-0.1042, 0.0000]`, compliance `0.0000`, recovery `+0.0417` CI `[0.0000, 0.1042]`, damage `+0.0417` CI `[0.0000, 0.1042]` | matched negative control 为严格零效应；只支持 `specific but behaviorally weak`；不能写成 positive confirmation | Appendix / boundary note | `paper_evidence_package_20260427/appendix_materials/qwen_clean_protocol_appendix_note.md`; `outputs/experiments/pressure_subspace_damping_qwen7b_clean/Qwen_Qwen2.5-7B-Instruct/20260430_161102/belief_causal_summary.csv` |
