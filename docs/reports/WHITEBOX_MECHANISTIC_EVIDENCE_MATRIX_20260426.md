...
| Qwen2.5-3B clean protocol | Appendix-level secondary positive support | clean protocol delta vs `no_intervention`: drift `-0.3750` CI `[-0.5208, -0.2292]`, compliance `-0.4167` CI `[-0.5625, -0.2708]`, recovery `+0.0833` CI `[0.0000, 0.1875]`, damage `+0.0417` CI `[0.0000, 0.1042]` | negative control 未复现收益，且 damage `+0.1458`; less-oracle `pressure_subspace_damping` 副证据；不替代 Qwen `baseline_state_interpolation` mainline | Appendix / boundary note | `paper_evidence_package_20260427/appendix_materials/qwen_clean_protocol_appendix_note.md`; `outputs/experiments/pressure_subspace_damping_qwen3b_clean/Qwen_Qwen2.5-3B-Instruct/20260430_162151/belief_causal_summary.csv` |
| Qwen2.5-7B clean protocol | Weak / boundary evidence | clean protocol delta vs `no_intervention`: drift `-0.0417` CI `[-0.1042, 0.0000]`, compliance `0.0000`, recovery `+0.0417` CI `[0.0000, 0.1042]`, damage `+0.0417` CI `[0.0000, 0.1042]` | matched negative control 为严格零效应；只支持 `specific but behaviorally weak`；不能写成 positive confirmation | Appendix / boundary note | `paper_evidence_package_20260427/appendix_materials/qwen_clean_protocol_appendix_note.md`; `outputs/experiments/pressure_subspace_damping_qwen7b_clean/Qwen_Qwen2.5-7B-Instruct/20260430_161102/belief_causal_summary.csv` |
| Qwen2.5-14B clean protocol n=48 | Cautionary / boundary evidence | clean protocol delta vs `no_intervention`: drift `+0.0417` CI `[-0.1042, 0.1875]`, compliance `-0.1042` CI `[-0.2083, 0.0000]`, recovery `-0.1042` CI `[-0.2500, 0.0625]`, damage `+0.1042` CI `[0.0208, 0.1875]` | harmful / not recommended；negative control 为零效应；不支持 clean positive secondary confirmation；不再写成 strengthens the 14B line | Appendix / boundary note | `paper_evidence_package_20260427/appendix_materials/qwen_clean_protocol_appendix_note.md`; `outputs/experiments/qwen14b_belief_causal_transfer_n48/Qwen_Qwen2.5-14B-Instruct/20260430_162437/belief_causal_summary.csv` |
