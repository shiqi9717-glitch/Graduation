...
推荐：
- `[src/stats/analyzer.py](/Users/shiqi/code/代码/毕业代码/src/stats/analyzer.py)`

可读性更明确的 analyzer 侧别名：
- `[src/analyzer/stats_analyzer.py](/Users/shiqi/code/代码/毕业代码/src/analyzer/stats_analyzer.py)`
...
推荐：
- `[src/analyzer/objective_case_extractor.py](/Users/shiqi/code/代码/毕业代码/src/analyzer/objective_case_extractor.py)`
...
推荐：
- `[src/stats/pair_case_report.py](/Users/shiqi/code/代码/毕业代码/src/stats/pair_case_report.py)`
...
文件：
- `[src/analyzer/analyzer.py](/Users/shiqi/code/代码/毕业代码/src/analyzer/analyzer.py)`
...
文件：
- `[src/analyzer/case_extractor.py](/Users/shiqi/code/代码/毕业代码/src/analyzer/case_extractor.py)`
...
文件：
- `[src/stats/case_extractor.py](/Users/shiqi/code/代码/毕业代码/src/stats/case_extractor.py)`
...
- `[scripts/run_analysis.py](/Users/shiqi/code/代码/毕业代码/scripts/run_analysis.py)` 使用 `StatsAnalyzer`
- `[scripts/run_full_pipeline.py](/Users/shiqi/code/代码/毕业代码/scripts/run_full_pipeline.py)` 使用 `StatsAnalyzer` + `ObjectiveCaseStudyExtractor`
